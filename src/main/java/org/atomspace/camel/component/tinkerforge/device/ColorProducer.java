...
public class ColorProducer extends TinkerforgeProducer<ColorEndpoint, BrickletColor> {

    private static final Logger LOG = LoggerFactory.getLogger(ColorProducer.class);
