...
public class IndustrialDigitalOut4Consumer extends TinkerforgeConsumer<IndustrialDigitalOut4Endpoint, BrickletIndustrialDigitalOut4> implements MonoflopDoneListener {
    ...
    public IndustrialDigitalOut4Consumer(IndustrialDigitalOut4Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void monoflopDone(int selection_mask, int value_mask) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletIndustrialDigitalOut4.CALLBACK_MONOFLOP_DONE);
