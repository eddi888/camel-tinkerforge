...
public class IMUProducer extends TinkerforgeProducer<IMUEndpoint, BrickIMU> {

    private static final Logger LOG = LoggerFactory.getLogger(IMUProducer.class);
    
    public IMUProducer(IMUEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
