...
public class VoltageCurrentConsumer extends TinkerforgeConsumer<VoltageCurrentEndpoint, BrickletVoltageCurrent> implements CurrentListener, VoltageListener, PowerListener, CurrentReachedListener, VoltageReachedListener, PowerReachedListener {
    ...
    public VoltageCurrentConsumer(VoltageCurrentEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void current(int current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_CURRENT);
    ...
    public void voltage(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_VOLTAGE);
    ...
    public void power(int power) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_POWER);
    ...
    public void currentReached(int current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_CURRENT_REACHED);
            exchange.getIn().setHeader("current", current);
    ...
    public void voltageReached(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_VOLTAGE_REACHED);
            exchange.getIn().setHeader("voltage", voltage);
    ...
    public void powerReached(int power) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltageCurrent.CALLBACK_POWER_REACHED);
            exchange.getIn().setHeader("power", power);
