...
public class AnalogOutV2Producer extends TinkerforgeProducer<AnalogOutV2Endpoint, BrickletAnalogOutV2> {
    ...
    public AnalogOutV2Producer(AnalogOutV2Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
        device = new BrickletAnalogOutV2(endpoint.getUid(),endpoint.getSharedConnection().getConnection());
    }
