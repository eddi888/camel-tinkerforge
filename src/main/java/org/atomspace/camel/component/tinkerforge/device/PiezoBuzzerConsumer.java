...
public class PiezoBuzzerConsumer extends TinkerforgeConsumer<PiezoBuzzerEndpoint, BrickletPiezoBuzzer> implements BeepFinishedListener, MorseCodeFinishedListener {
    ...
    public PiezoBuzzerConsumer(PiezoBuzzerEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void beepFinished() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPiezoBuzzer.CALLBACK_BEEP_FINISHED);
    ...
    public void morseCodeFinished() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPiezoBuzzer.CALLBACK_MORSE_CODE_FINISHED);
