...
public class Current12Consumer extends TinkerforgeConsumer<Current12Endpoint, BrickletCurrent12> implements CurrentListener, AnalogValueListener, CurrentReachedListener, AnalogValueReachedListener, OverCurrentListener {
    ...
    public Current12Consumer(Current12Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void current(short current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletCurrent12.CALLBACK_CURRENT);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletCurrent12.CALLBACK_ANALOG_VALUE);
    ...
    public void currentReached(short current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletCurrent12.CALLBACK_CURRENT_REACHED);
            exchange.getIn().setHeader("current", current);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletCurrent12.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
    ...
    public void overCurrent() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletCurrent12.CALLBACK_OVER_CURRENT);
