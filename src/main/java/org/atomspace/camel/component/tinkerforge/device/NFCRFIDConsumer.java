...
public class NFCRFIDConsumer extends TinkerforgeConsumer<NFCRFIDEndpoint, BrickletNFCRFID> implements StateChangedListener {
    
    private static final Logger LOG = LoggerFactory.getLogger(NFCRFIDConsumer.class);
    
    public NFCRFIDConsumer(NFCRFIDEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void stateChanged(short state, boolean idle) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletNFCRFID.CALLBACK_STATE_CHANGED);
