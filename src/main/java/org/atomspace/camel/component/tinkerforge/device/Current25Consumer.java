...
public class Current25Consumer extends TinkerforgeConsumer<Current25Endpoint, BrickletCurrent25> implements CurrentListener, AnalogValueListener, CurrentReachedListener, AnalogValueReachedListener, OverCurrentListener {
    ...
    public void current(short current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletCurrent25.CALLBACK_CURRENT);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletCurrent25.CALLBACK_ANALOG_VALUE);
    ...
    public void currentReached(short current) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletCurrent25.CALLBACK_CURRENT_REACHED);
            exchange.getIn().setHeader("current", current);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletCurrent25.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
    ...
    public void overCurrent() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletCurrent25.CALLBACK_OVER_CURRENT);
