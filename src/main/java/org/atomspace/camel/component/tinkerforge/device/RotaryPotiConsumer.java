...
public class RotaryPotiConsumer extends TinkerforgeConsumer<RotaryPotiEndpoint, BrickletRotaryPoti> implements PositionListener, AnalogValueListener, PositionReachedListener, AnalogValueReachedListener {
    ...
    public void position(short position) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletRotaryPoti.CALLBACK_POSITION);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletRotaryPoti.CALLBACK_ANALOG_VALUE);
    ...
    public void positionReached(short position) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletRotaryPoti.CALLBACK_POSITION_REACHED);
            exchange.getIn().setHeader("position", position);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("fireBy", BrickletRotaryPoti.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
