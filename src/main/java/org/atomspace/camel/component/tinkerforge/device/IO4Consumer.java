...
public class IO4Consumer extends TinkerforgeConsumer<IO4Endpoint, BrickletIO4> implements InterruptListener, MonoflopDoneListener {
    ...
    public IO4Consumer(IO4Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void interrupt(short interrupt_mask, short value_mask) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletIO4.CALLBACK_INTERRUPT);
    ...
    public void monoflopDone(short selection_mask, short value_mask) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletIO4.CALLBACK_MONOFLOP_DONE);
