...
public class LCD16x2Producer extends TinkerforgeProducer<LCD16x2Endpoint, BrickletLCD16x2> {

    private static final Logger LOG = LoggerFactory.getLogger(LCD16x2Producer.class);
    
    public LCD16x2Producer(LCD16x2Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
