...
public class RotaryEncoderConsumer extends TinkerforgeConsumer<RotaryEncoderEndpoint, BrickletRotaryEncoder> implements CountListener, CountReachedListener, PressedListener, ReleasedListener {
    ...
    public RotaryEncoderConsumer(RotaryEncoderEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void count(int count) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletRotaryEncoder.CALLBACK_COUNT);
    ...
    public void countReached(int count) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletRotaryEncoder.CALLBACK_COUNT_REACHED);
            exchange.getIn().setHeader("count", count);
    ...
    public void pressed() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletRotaryEncoder.CALLBACK_PRESSED);
    ...
    public void released() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletRotaryEncoder.CALLBACK_RELEASED);
