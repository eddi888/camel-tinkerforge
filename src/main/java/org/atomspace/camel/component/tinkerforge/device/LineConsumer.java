...
public class LineConsumer extends TinkerforgeConsumer<LineEndpoint, BrickletLine> implements ReflectivityListener, ReflectivityReachedListener {
    ...
    public LineConsumer(LineEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void reflectivity(int reflectivity) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLine.CALLBACK_REFLECTIVITY);
    ...
    public void reflectivityReached(int reflectivity) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLine.CALLBACK_REFLECTIVITY_REACHED);
            exchange.getIn().setHeader("reflectivity", reflectivity);
