...
public class IO16Producer extends TinkerforgeProducer<IO16Endpoint, BrickletIO16> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IO16Producer.class);
    
    public IO16Producer(IO16Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
