...
public class MasterProducer extends TinkerforgeProducer<MasterEndpoint, BrickMaster> {

    private static final Logger LOG = LoggerFactory.getLogger(MasterProducer.class);
    
    public MasterProducer(MasterEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
