...
public class Current12Producer extends TinkerforgeProducer<Current12Endpoint, BrickletCurrent12> {

    private static final Logger LOG = LoggerFactory.getLogger(Current12Producer.class);
    
    public Current12Producer(Current12Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
