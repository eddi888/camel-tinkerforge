...
public class StepperProducer extends TinkerforgeProducer<StepperEndpoint, BrickStepper> {

    private static final Logger LOG = LoggerFactory.getLogger(StepperProducer.class);
    
    public StepperProducer(StepperEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
