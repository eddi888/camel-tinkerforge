 ...
 */
@UriEndpoint(scheme = "tinkerforgegen", syntax = "tinkerforgegen:[host[:port]/]voltage", consumerClass = VoltageConsumer.class, label = "iot", title = "Tinkerforge")
public class VoltageEndpoint extends TinkerforgeEndpoint<VoltageConsumer, VoltageProducer> {

    private static final Logger LOG = LoggerFactory.getLogger(VoltageEndpoint.class);
    ...
    public VoltageEndpoint(String uri, TinkerforgeComponent tinkerforgeComponent) {
    ...
    public Producer createProducer() throws Exception {
        ...
        if(producer==null){
            producer = new VoltageProducer(this);
        }
        return producer;
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ...
        if(consumer==null){
            consumer = new VoltageConsumer(this, processor);
        }
        return consumer;
    }
    ...
    public void init(BrickletVoltage device) throws Exception {
    ...
    public Object callFunction(BrickletVoltage device, String function, Message m, Endpoint e) throws Exception{
