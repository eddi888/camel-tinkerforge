...
public class ThermocoupleProducer extends TinkerforgeProducer<ThermocoupleEndpoint, BrickletThermocouple> {

    private static final Logger LOG = LoggerFactory.getLogger(ThermocoupleProducer.class);
    
    public ThermocoupleProducer(ThermocoupleEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
