...
public class ServoConsumer extends TinkerforgeConsumer<ServoEndpoint, BrickServo> implements UnderVoltageListener, PositionReachedListener, VelocityReachedListener {
    ...
    public ServoConsumer(ServoEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void underVoltage(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickServo.CALLBACK_UNDER_VOLTAGE);
    ...
    public void positionReached(short servo_num, short position) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickServo.CALLBACK_POSITION_REACHED);
    ...
    public void velocityReached(short servo_num, short velocity) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickServo.CALLBACK_VELOCITY_REACHED);
            exchange.getIn().setHeader("servo_num", servo_num);
