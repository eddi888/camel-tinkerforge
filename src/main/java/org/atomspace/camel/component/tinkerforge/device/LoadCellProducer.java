...
public class LoadCellProducer extends TinkerforgeProducer<LoadCellEndpoint, BrickletLoadCell> {

    private static final Logger LOG = LoggerFactory.getLogger(LoadCellProducer.class);
    
    public LoadCellProducer(LoadCellEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
