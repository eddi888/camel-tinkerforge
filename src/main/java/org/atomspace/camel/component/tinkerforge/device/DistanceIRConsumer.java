...
public class DistanceIRConsumer extends TinkerforgeConsumer<DistanceIREndpoint, BrickletDistanceIR> implements DistanceListener, AnalogValueListener, DistanceReachedListener, AnalogValueReachedListener {
    ...
    public DistanceIRConsumer(DistanceIREndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void distance(int distance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceIR.CALLBACK_DISTANCE);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceIR.CALLBACK_ANALOG_VALUE);
    ...
    public void distanceReached(int distance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceIR.CALLBACK_DISTANCE_REACHED);
            exchange.getIn().setHeader("distance", distance);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceIR.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
