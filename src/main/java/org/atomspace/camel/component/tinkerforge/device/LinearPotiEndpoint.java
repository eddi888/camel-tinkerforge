 ...
 */
@UriEndpoint(scheme = "tinkerforgegen", syntax = "tinkerforgegen:[host[:port]/]linearpoti", consumerClass = LinearPotiConsumer.class, label = "iot", title = "Tinkerforge")
public class LinearPotiEndpoint extends TinkerforgeEndpoint<LinearPotiConsumer, LinearPotiProducer> {

    private static final Logger LOG = LoggerFactory.getLogger(LinearPotiEndpoint.class);
    ...
    public LinearPotiEndpoint(String uri, TinkerforgeComponent tinkerforgeComponent) {
    ...
    public Producer createProducer() throws Exception {
        ...
        if(producer==null){
            producer = new LinearPotiProducer(this);
        }
        return producer;
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ...
        if(consumer==null){
            consumer = new LinearPotiConsumer(this, processor);
        }
        return consumer;
    }
    ...
    public void init(BrickletLinearPoti device) throws Exception {
    ...
    public Object callFunction(BrickletLinearPoti device, String function, Message m, Endpoint e) throws Exception{
