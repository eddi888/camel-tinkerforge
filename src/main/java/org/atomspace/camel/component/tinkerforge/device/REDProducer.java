...
public class REDProducer extends TinkerforgeProducer<REDEndpoint, BrickRED> {

    private static final Logger LOG = LoggerFactory.getLogger(REDProducer.class);
    
    public REDProducer(REDEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
