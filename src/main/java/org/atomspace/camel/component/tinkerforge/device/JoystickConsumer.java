...
public class JoystickConsumer extends TinkerforgeConsumer<JoystickEndpoint, BrickletJoystick> implements PositionListener, AnalogValueListener, PositionReachedListener, AnalogValueReachedListener, PressedListener, ReleasedListener {
    ...
    public JoystickConsumer(JoystickEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void position(short x, short y) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_POSITION);
    ...
    public void analogValue(int x, int y) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_ANALOG_VALUE);
            exchange.getIn().setHeader("x", x);
            exchange.getIn().setHeader("y", y);
    ...
    public void positionReached(short x, short y) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_POSITION_REACHED);
            exchange.getIn().setHeader("x", x);
            exchange.getIn().setHeader("y", y);
    ...
    public void analogValueReached(int x, int y) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("x", x);
            exchange.getIn().setHeader("y", y);
    ...
    public void pressed() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_PRESSED);
    ...
    public void released() {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletJoystick.CALLBACK_RELEASED);
