...
public class Current25Endpoint extends TinkerforgeEndpoint<Current25Consumer, Current25Producer> {
    ...
    public Current25Endpoint(String uri, TinkerforgeComponent tinkerforgeComponent) {
    ...
    public Producer createProducer() throws Exception {
        ...
        if(producer==null){
            producer = new Current25Producer(this);
        }
        return producer;
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ...
        if(consumer==null){
            consumer = new Current25Consumer(this, processor);
        }
        return consumer;
    }
    ...
    public void init(BrickletCurrent25 device) throws Exception {
    ...
    public Object callFunction(BrickletCurrent25 device, String function, Message m, Endpoint e) throws Exception{
