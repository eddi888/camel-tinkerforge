...
public class UVLightProducer extends TinkerforgeProducer<UVLightEndpoint, BrickletUVLight> {

    private static final Logger LOG = LoggerFactory.getLogger(UVLightProducer.class);
    
    public UVLightProducer(UVLightEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
