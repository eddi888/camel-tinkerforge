...
public class PTCConsumer extends TinkerforgeConsumer<PTCEndpoint, BrickletPTC> implements TemperatureListener, TemperatureReachedListener, ResistanceListener, ResistanceReachedListener {
    ...
    public PTCConsumer(PTCEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void temperature(int temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPTC.CALLBACK_TEMPERATURE);
    ...
    public void temperatureReached(int temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPTC.CALLBACK_TEMPERATURE_REACHED);
            exchange.getIn().setHeader("temperature", temperature);
    ...
    public void resistance(int resistance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPTC.CALLBACK_RESISTANCE);
    ...
    public void resistanceReached(int resistance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletPTC.CALLBACK_RESISTANCE_REACHED);
            exchange.getIn().setHeader("resistance", resistance);
