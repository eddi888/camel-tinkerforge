...
public class HallEffectConsumer extends TinkerforgeConsumer<HallEffectEndpoint, BrickletHallEffect> implements EdgeCountListener {
    ...
    public HallEffectConsumer(HallEffectEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void edgeCount(long count, boolean value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletHallEffect.CALLBACK_EDGE_COUNT);
