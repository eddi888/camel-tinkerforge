...
public class HumidityConsumer extends TinkerforgeConsumer<HumidityEndpoint, BrickletHumidity> implements HumidityListener, AnalogValueListener, HumidityReachedListener, AnalogValueReachedListener {
    ...
    public HumidityConsumer(HumidityEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void humidity(int humidity) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletHumidity.CALLBACK_HUMIDITY);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletHumidity.CALLBACK_ANALOG_VALUE);
    ...
    public void humidityReached(int humidity) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletHumidity.CALLBACK_HUMIDITY_REACHED);
            exchange.getIn().setHeader("humidity", humidity);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletHumidity.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
