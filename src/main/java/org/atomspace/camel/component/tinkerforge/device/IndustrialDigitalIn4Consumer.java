...
public class IndustrialDigitalIn4Consumer extends TinkerforgeConsumer<IndustrialDigitalIn4Endpoint, BrickletIndustrialDigitalIn4> implements InterruptListener {
    ...
    public IndustrialDigitalIn4Consumer(IndustrialDigitalIn4Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void interrupt(int interrupt_mask, int value_mask) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletIndustrialDigitalIn4.CALLBACK_INTERRUPT);
