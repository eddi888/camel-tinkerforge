...
public class LCD16x2Consumer extends TinkerforgeConsumer<LCD16x2Endpoint, BrickletLCD16x2> implements ButtonPressedListener, ButtonReleasedListener {
    ...
    public LCD16x2Consumer(LCD16x2Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void buttonPressed(short button) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLCD16x2.CALLBACK_BUTTON_PRESSED);
    ...
    public void buttonReleased(short button) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLCD16x2.CALLBACK_BUTTON_RELEASED);
            exchange.getIn().setHeader("button", button);
