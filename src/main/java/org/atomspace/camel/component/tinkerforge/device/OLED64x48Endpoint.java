 ...
 */
@UriEndpoint(scheme = "tinkerforgegen", syntax = "tinkerforgegen:[host[:port]/]oled64x48", consumerClass = OLED64x48Consumer.class, label = "iot", title = "Tinkerforge")
public class OLED64x48Endpoint extends TinkerforgeEndpoint<OLED64x48Consumer, OLED64x48Producer> {

    private static final Logger LOG = LoggerFactory.getLogger(OLED64x48Endpoint.class);
    ...
    public OLED64x48Endpoint(String uri, TinkerforgeComponent tinkerforgeComponent) {
    ...
    public Producer createProducer() throws Exception {
        ...
        if(producer==null){
            producer = new OLED64x48Producer(this);
        }
        return producer;
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        ...
        if(consumer==null){
            consumer = new OLED64x48Consumer(this, processor);
        }
        return consumer;
    }
    ...
    public void init(BrickletOLED64x48 device) throws Exception {
    ...
    public Object callFunction(BrickletOLED64x48 device, String function, Message m, Endpoint e) throws Exception{
