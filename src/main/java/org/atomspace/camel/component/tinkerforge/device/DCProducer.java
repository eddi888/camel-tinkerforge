...
public class DCProducer extends TinkerforgeProducer<DCEndpoint, BrickDC> {

    private static final Logger LOG = LoggerFactory.getLogger(DCProducer.class);
    
    public DCProducer(DCEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
