...
public class AnalogOutProducer extends TinkerforgeProducer<AnalogOutEndpoint, BrickletAnalogOut> {

    private static final Logger LOG = LoggerFactory.getLogger(AnalogOutProducer.class);
    
    public AnalogOutProducer(AnalogOutEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
