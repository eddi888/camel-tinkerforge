...
public class AmbientLightConsumer extends TinkerforgeConsumer<AmbientLightEndpoint, BrickletAmbientLight> implements IlluminanceListener, AnalogValueListener, IlluminanceReachedListener, AnalogValueReachedListener {
    ...
    public AmbientLightConsumer(AmbientLightEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void illuminance(int illuminance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletAmbientLight.CALLBACK_ILLUMINANCE);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletAmbientLight.CALLBACK_ANALOG_VALUE);
    ...
    public void illuminanceReached(int illuminance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletAmbientLight.CALLBACK_ILLUMINANCE_REACHED);
            exchange.getIn().setHeader("illuminance", illuminance);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletAmbientLight.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
