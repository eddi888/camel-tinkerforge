...
public class LCD20x4Consumer extends TinkerforgeConsumer<LCD20x4Endpoint, BrickletLCD20x4> implements ButtonPressedListener, ButtonReleasedListener {
    ...
    public LCD20x4Consumer(LCD20x4Endpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void buttonPressed(short button) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLCD20x4.CALLBACK_BUTTON_PRESSED);
    ...
    public void buttonReleased(short button) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLCD20x4.CALLBACK_BUTTON_RELEASED);
            exchange.getIn().setHeader("button", button);
