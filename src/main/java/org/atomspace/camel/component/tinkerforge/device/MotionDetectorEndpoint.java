...
public class MotionDetectorEndpoint extends TinkerforgeEndpoint<MotionDetectorConsumer, MotionDetectorProducer> {
    ...
    public void init(BrickletMotionDetector device) throws Exception {
    ...
    public Object callFunction(BrickletMotionDetector device, String function, Message m, Endpoint e) throws Exception{
        Object response = null;
        switch (function) {
                
            case "getMotionDetected":
                response = device.getMotionDetected();
                break;
