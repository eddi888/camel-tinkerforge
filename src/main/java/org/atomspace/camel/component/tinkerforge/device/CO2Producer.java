...
public class CO2Producer extends TinkerforgeProducer<CO2Endpoint, BrickletCO2> {

    private static final Logger LOG = LoggerFactory.getLogger(CO2Producer.class);
    
    public CO2Producer(CO2Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
