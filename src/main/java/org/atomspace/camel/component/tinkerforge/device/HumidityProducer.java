...
public class HumidityProducer extends TinkerforgeProducer<HumidityEndpoint, BrickletHumidity> {

    private static final Logger LOG = LoggerFactory.getLogger(HumidityProducer.class);
    
    public HumidityProducer(HumidityEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
