...
public class TemperatureIRConsumer extends TinkerforgeConsumer<TemperatureIREndpoint, BrickletTemperatureIR> implements AmbientTemperatureListener, ObjectTemperatureListener, AmbientTemperatureReachedListener, ObjectTemperatureReachedListener {
    ...
    public TemperatureIRConsumer(TemperatureIREndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void ambientTemperature(short temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletTemperatureIR.CALLBACK_AMBIENT_TEMPERATURE);
    ...
    public void objectTemperature(short temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletTemperatureIR.CALLBACK_OBJECT_TEMPERATURE);
            exchange.getIn().setHeader("temperature", temperature);
    ...
    public void ambientTemperatureReached(short temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletTemperatureIR.CALLBACK_AMBIENT_TEMPERATURE_REACHED);
            exchange.getIn().setHeader("temperature", temperature);
    ...
    public void objectTemperatureReached(short temperature) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletTemperatureIR.CALLBACK_OBJECT_TEMPERATURE_REACHED);
            exchange.getIn().setHeader("temperature", temperature);
