...
public class TiltConsumer extends TinkerforgeConsumer<TiltEndpoint, BrickletTilt> implements TiltStateListener {
    ...
    public TiltConsumer(TiltEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void tiltState(short state) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletTilt.CALLBACK_TILT_STATE);
