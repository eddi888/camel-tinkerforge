...
public class StepperConsumer extends TinkerforgeConsumer<StepperEndpoint, BrickStepper> implements UnderVoltageListener, PositionReachedListener, AllDataListener, NewStateListener {
    ...
    public StepperConsumer(StepperEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void underVoltage(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickStepper.CALLBACK_UNDER_VOLTAGE);
    ...
    public void positionReached(int position) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickStepper.CALLBACK_POSITION_REACHED);
    ...
    public void allData(int current_velocity, int current_position, int remaining_steps, int stack_voltage, int external_voltage, int current_consumption) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickStepper.CALLBACK_ALL_DATA);
    ...
    public void newState(short state_new, short state_previous) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickStepper.CALLBACK_NEW_STATE);
