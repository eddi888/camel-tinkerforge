...
public class LEDStripConsumer extends TinkerforgeConsumer<LEDStripEndpoint, BrickletLEDStrip> implements FrameRenderedListener {
    ...
    public LEDStripConsumer(LEDStripEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void frameRendered(int length) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletLEDStrip.CALLBACK_FRAME_RENDERED);
