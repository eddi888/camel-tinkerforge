...
public class MultiTouchConsumer extends TinkerforgeConsumer<MultiTouchEndpoint, BrickletMultiTouch> implements TouchStateListener {
    ...
    public MultiTouchConsumer(MultiTouchEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void touchState(int state) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletMultiTouch.CALLBACK_TOUCH_STATE);
