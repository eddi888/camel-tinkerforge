...
public class TemperatureProducer extends TinkerforgeProducer<TemperatureEndpoint, BrickletTemperature> {

    private static final Logger LOG = LoggerFactory.getLogger(TemperatureProducer.class);
    
    public TemperatureProducer(TemperatureEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
