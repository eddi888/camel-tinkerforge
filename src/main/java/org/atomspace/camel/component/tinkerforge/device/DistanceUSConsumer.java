...
public class DistanceUSConsumer extends TinkerforgeConsumer<DistanceUSEndpoint, BrickletDistanceUS> implements DistanceListener, DistanceReachedListener {
    ...
    public DistanceUSConsumer(DistanceUSEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void distance(int distance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceUS.CALLBACK_DISTANCE);
    ...
    public void distanceReached(int distance) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletDistanceUS.CALLBACK_DISTANCE_REACHED);
            exchange.getIn().setHeader("distance", distance);
