...
public class TinkerforgeComponent extends DefaultComponent {
    ...
    protected Endpoint createEndpoint(String endpointUri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        switch (brickletType) {
            ...
            case "temperature"              :       endpoint = new StepperEndpoint(endpointUri, this); break;
            case "temperatureir"            :       endpoint = new StepperEndpoint(endpointUri, this); break;
            case "tilt"                     :       endpoint = new StepperEndpoint(endpointUri, this); break;
