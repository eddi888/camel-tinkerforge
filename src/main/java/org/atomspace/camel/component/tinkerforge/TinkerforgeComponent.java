...
import org.atomspace.camel.component.tinkerforge.device.CO2Endpoint;
...
import org.atomspace.camel.component.tinkerforge.device.OLED128x64Endpoint;
import org.atomspace.camel.component.tinkerforge.device.OLED64x48Endpoint;
...
import org.atomspace.camel.component.tinkerforge.device.RealTimeClockEndpoint;
...
import org.atomspace.camel.component.tinkerforge.device.ThermocoupleEndpoint;
import org.atomspace.camel.component.tinkerforge.device.TiltEndpoint;
import org.atomspace.camel.component.tinkerforge.device.UVLightEndpoint;
...
public class TinkerforgeComponent extends DefaultComponent {
    ...
    protected Endpoint createEndpoint(String endpointUri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        switch (brickletType) {
            ...
            case "co2"                      :       endpoint = new CO2Endpoint(endpointUri, this); break;
            ...
            case "oled128x64"               :       endpoint = new OLED128x64Endpoint(endpointUri, this); break;
            case "oled64x48"                :       endpoint = new OLED64x48Endpoint(endpointUri, this); break;
            ...
            case "realtimeclock"            :       endpoint = new RealTimeClockEndpoint(endpointUri, this); break;
            ...
            case "thermocouple"             :       endpoint = new ThermocoupleEndpoint(endpointUri, this); break;
            case "tilt"                     :       endpoint = new TiltEndpoint(endpointUri, this); break;
            case "uvlight"                  :       endpoint = new UVLightEndpoint(endpointUri, this); break;
