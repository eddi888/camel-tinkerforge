...
public class MoistureProducer extends TinkerforgeProducer<MoistureEndpoint, BrickletMoisture> {

    private static final Logger LOG = LoggerFactory.getLogger(MoistureProducer.class);
    
    public MoistureProducer(MoistureEndpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
