...
public class VoltageConsumer extends TinkerforgeConsumer<VoltageEndpoint, BrickletVoltage> implements VoltageListener, AnalogValueListener, VoltageReachedListener, AnalogValueReachedListener {
    ...
    public VoltageConsumer(VoltageEndpoint endpoint, Processor processor) throws UnknownHostException, AlreadyConnectedException, IOException {
    ...
    public void voltage(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltage.CALLBACK_VOLTAGE);
    ...
    public void analogValue(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltage.CALLBACK_ANALOG_VALUE);
    ...
    public void voltageReached(int voltage) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltage.CALLBACK_VOLTAGE_REACHED);
            exchange.getIn().setHeader("voltage", voltage);
    ...
    public void analogValueReached(int value) {
        ...
        try {
            ...
            // ADD HEADER
            exchange.getIn().setHeader("CALLBACK", BrickletVoltage.CALLBACK_ANALOG_VALUE_REACHED);
            exchange.getIn().setHeader("value", value);
