...
public class IO4Producer extends TinkerforgeProducer<IO4Endpoint, BrickletIO4> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IO4Producer.class);
    
    public IO4Producer(IO4Endpoint endpoint) throws UnknownHostException, AlreadyConnectedException, IOException {
        super(endpoint);
